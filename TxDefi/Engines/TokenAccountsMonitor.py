...
class TokenAccountsMonitor(AbstractSubscriber[AccountInfo]):
    ...
    def _handle_amm_data_task(self, arg1: list[MarketAlert]): #use generics to prevent misuse
        with concurrent.futures.ThreadPoolExecutor() as executor: 
            ...
            executor.submit(self.notify_data_subscribers, arg1)

    def notify_data_subscribers(self, data):
        pub.sendMessage(topicName=globals.topic_parsed_tx_data, arg1=data)
