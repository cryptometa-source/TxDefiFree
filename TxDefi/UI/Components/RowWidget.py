...
class BuyTradeWidget(TradeWidget):
    ...
    def init_row_items(self) -> list:
        ...
        fast_buy_command = TradeCommand(UI_Command.FAST_BUY, self.token_address, None, False, True)  #TODO use default amounts
        ...
        property = ClickableProperty(lambda e: topic_helper.send(deleteCommand), "❌", styleTag=globals.highlight_red)  
        additional_items.append(property)  
    ...
    @staticmethod
    def get_header():
        return ("Mint", "Stats", "Socials", "Fast Buy", "") 
...
class SellTradeWidget(TradeWidget):
    ...
    def init_row_items(self) -> list:   
        ...
        fastSellCommand = TradeCommand(UI_Command.FAST_SELL, self.token_address, None, False, True) #TODO
