...
def create_icon_button(parent, image_data: str, command, width = 10, height = 10)->ctk.CTkButton:    
    config_logo = create_ctk_image_component(image_data)
    return ctk.CTkButton(parent, width=width, height=height, image=config_logo, fg_color="transparent", hover=False, text="", command=command)
