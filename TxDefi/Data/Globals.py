...
txdefi_jteye_path = images_path + '/justtheeyesmall.png'
...
pnl_image_path = library_root + "/Resources/images/pnltemplate.jpg"
...
topic_parsed_tx_data = "topic_parsed_tx_data"
...
topic_token_alerts = "topic_token_alerts" #Mainly for UI
...
blackops_font_path = library_root + "/Resources/fonts/BlackOpsOne-Regular.ttf"
bebas_font_path = library_root + "/Resources/fonts/BebasNeue-Regular.ttf"

#Strategy Frame Colors
sf_button_color = "#183a58"
sf_header_color = "black"
sf_off_color = "#191a19"
sf_on_color = "#128412"
...
class TopicHelper:
    ...
    def send(self, command: Command):
        threading.Thread(target=self._send_task, args=(command,), daemon=True).start()
