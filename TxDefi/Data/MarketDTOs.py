...
class TokenInfo:
    ...
    def copy_missing_metadata(self, metadata: ExtendedMetadata):
        ...
        if len(self.metadata.creator_address) == 0:
            self.metadata.creator_address = metadata.creator_address
    ...
    def create(program_type: SupportedPrograms, token_address: str, sol_vault_address: str, token_vault_address: str, 
               init_sol_amount: Amount, init_token_amount: Amount)->"TokenInfo":
        ret_token_info = TokenInfo(token_address, init_token_amount.decimals)
        ...
        ret_token_info.metadata.supply = Amount.tokens_ui(0, init_token_amount.decimals)
