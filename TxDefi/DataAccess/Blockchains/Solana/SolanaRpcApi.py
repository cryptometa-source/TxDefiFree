...
class SolanaRpcApi(RateLimiter):
    ...
    def parse_swap_transactions(owner_address: str, transaction_data: dict)->list[SwapTransactionInfo]:
        ...
        if owner_account_index >= 0:
            ...
            for mint_address in post_token_balances.keys():             
                ...
                transaction_info.fee = fee #Shared between transaction TODO put swap transactions into an aggregator class         
    ...
    @staticmethod
    def get_account_address_with_seeds(seeds: list[bytes], program_address: str)->str:
        return str(Pubkey.find_program_address(seeds, Pubkey.from_string(program_address))[0])
